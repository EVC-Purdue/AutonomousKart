...
def generate_launch_description():
    ...
    return LaunchDescription([
        Node(
            ...
            name='motor_node',
            parameters=[os.path.join(pkg_share, 'params', 'controller.yaml'), {'simulation_mode': True}]
        ),
        Node(
            package='autonomous_kart',
        ...
        Node(
            ...
            name='camera_node',
            parameters=[os.path.join(pkg_share, 'params', 'camera.yaml'), {'simulation_mode': True}]
        ),
        Node(
            package='autonomous_kart',
