...
class SteeringNode(Node):
    def __init__(self):
        ...
        self.cmd_turn_sub: Subscription = self.create_subscription(
            Float32, "cmd_turn", self.cmd_turn_callback, 5
        )

        # Publisher for steering angular velocity
        self.turn_pub: Publisher = self.create_publisher(Float32, "turn_angle", 5)

        self.current_angle: Float32 | float = Float32()
